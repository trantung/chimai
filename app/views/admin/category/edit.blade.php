...
<div class="row margin-bottom">
	<div class="col-xs-12">
		<a href="{{ action('AdminCategoryController@index') }} " class="btn btn-success">Danh sách category</a>
	</div>
</div>
<div class="row">
	<div class="col-xs-12">
		<div class="box box-primary">
		{{ Form::open(array('action' => array('AdminCategoryController@update', $boxVi->id) , 'method' => 'PUT', 'files' => true)) }}
			<div class="box-body">
