	  ...
	  <div class="box">
		...
		<div class="box-body table-responsive no-padding">
			<table class="table table-hover">
				...
				@foreach(Category::whereIn('id', $list)->get() as $box)
					<tr>
						<td>{{ $box->id }}</td>
						<td>{{ $box->name }}</td>
						...
						<td>
							<a href="{{ action('AdminCategoryController@edit', $box->id) }}" class="btn btn-primary">Sửa</a>
							{{ Form::open(array('method'=>'DELETE', 'action' => array('AdminCategoryController@destroy', $box->id), 'style' => 'display: inline-block;')) }}
