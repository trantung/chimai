...
@section('title')
{{ $title='Chỉnh sửa box collection' }}
@stop
...
<div class="row">
	<div class="col-xs-12">
		...
		{{ Form::open(array('action' => array('BoxCollectionController@update', $boxVi->id) , 'method' => 'PUT', 'files' => true)) }}
			<div class="box-body">
				...
				<div class="form-group">
					...
					{{ Form::file('image_url') }}
					<img class="image_boxCollection" src="{{ url(UPLOADIMG . '/BoxCollection/' . $boxVi->id . '/' . $boxVi->image_url) }}" />
				</div>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										{{ Form::text('weight_number[]', Common::getValueCommonBox($boxVi->id, 'BoxCollection', MENU, 'weight_number'), textPlaceHolder('Mức ưu tiên')) }}
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										{{ Form::select('status[]', Common::getStatus(), Common::getValueCommonBox($boxVi->id, 'BoxCollection', MENU, 'status'), array('class' => 'form-control')) }}
									</div>
								</div>
							</div>
						</div>
						...
						<div class="tab-pane" id="tab_2">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										{{ Form::text('weight_number[]', Common::getValueCommonBox($boxVi->id, 'BoxCollection', CONTENT, 'weight_number'), textPlaceHolder('Mức ưu tiên')) }}
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										{{ Form::select('status[]', Common::getStatus(),  Common::getValueCommonBox($boxVi->id, 'BoxCollection', CONTENT, 'status'), array('class' => 'form-control')) }}
									</div>
								</div>
							</div>
						</div>
						...
						<div class="tab-pane" id="tab_3">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										{{ Form::text('weight_number[]', Common::getValueCommonBox($boxVi->id, 'BoxCollection', FOOTER, 'weight_number'), textPlaceHolder('Mức ưu tiên')) }}
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										{{ Form::select('status[]', Common::getStatus(),  Common::getValueCommonBox($boxVi->id, 'BoxCollection', FOOTER, 'status'), array('class' => 'form-control')) }}
									</div>
								</div>
							</div>
						</div>
