...
<div class="row">
	<div class="col-xs-12">
		...
		{{ Form::open(array('action' => array('BoxShowRoomController@store'), 'files' => true)) }}
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-6">
						{{ Form::select('box_collection_id[]', Common::getCollection('CollectionBoxShowroom', 'box_show_room_id'), '', array('class' => 'form-control', 'multiple' => true)) }}
						</div>
					</div>
				</div>
				<div class="form-group">
