	...
	<div class="col-xs-12">
		...
		{{ Form::open(array('action' => array('BoxProductController@update', $boxVi->id) , 'method' => 'PUT', 'files' => true)) }}
			<div class="box-body">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1">
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										{{ Form::select('origin_id[]', Common::getOrigin(), Common::getOrigin($boxVi->id), array('class' => 'form-control', 'multiple' => true)) }}
									</div>
								</div>
							</div>
							<div class="form-group">
				...
				@include('admin.common.meta', ['modelName' => 'BoxProduct', 'modelId' => $boxVi->id])
